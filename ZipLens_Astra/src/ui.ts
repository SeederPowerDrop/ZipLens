...
export const elements = {
  ...
  get btnOpenArchive() { return document.getElementById("btn-open-archive"); },
  get btnExtract() { return document.getElementById("btn-extract"); },
  get btnSmartExtract() { return document.getElementById("btn-smart-extract"); },
  get btnCompress() { return document.getElementById("btn-compress"); },
  get compressionOptions() { return document.getElementById("compression-options"); },
  get btnCancelCompress() { return document.getElementById("btn-cancel-compress"); },
  get btnConfirmCompress() { return document.getElementById("btn-confirm-compress"); },
  ...
  get viewerModal() { return document.getElementById("viewer-modal") as HTMLDivElement; },
  get viewerTitle() { return document.getElementById("viewer-title") as HTMLSpanElement; },
  get viewerImg() { return document.getElementById("viewer-img") as HTMLImageElement; },
  get viewerText() { return document.getElementById("viewer-text") as HTMLPreElement; },
  get viewerClose() { return document.getElementById("viewer-close") as HTMLButtonElement; },
